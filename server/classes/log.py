...
class Log:
    ...
    def __init__(self, id_logs=None, link=None, descricao=None, id_piloto=None, data=None, id_teste=None, passada=None, 
        time=None, rpm=None, tps=None, battery_voltage=None, oil_temp=None, oil_press=None, engine_temp=None, 
        air_temp=None, lambdas=None, fuel_flow=None, fuel_press=None, brake_press_f=None, brake_press_r=None, 
        WPS=None, v_diff=None, v_fl=None, v_fr=None, gear=None, ax=None, ay=None, damp_xfl=None, damp_xrl=None):
        ...
        self.oil_press = oil_press
        self.engine_temp = engine_temp
        self.air_temp = air_temp
        self.lambdas = lambdas
        self.fuel_flow = fuel_flow
        self.fuel_press = fuel_press
        self.brake_press_f = brake_press_f
        self.brake_press_r = brake_press_r
        self.WPS = WPS
        self.v_diff = v_diff
        self.v_fl = v_fl
        self.v_fr = v_fr
        ...
        self.ax = ax
        self.ay = ay
        self.damp_xfl = damp_xfl
        self.damp_xrl = damp_xrl
